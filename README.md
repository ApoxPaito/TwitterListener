...
Also if you're by chance using Win7, you might wanna recompile this because the one time I tried it on a Win7 VM the program crashed. Can't really see the stack trace of it but I'm gonna bet it has to do with the way file I/O working different there.
